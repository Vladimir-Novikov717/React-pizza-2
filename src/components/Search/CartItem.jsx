...
import { addItem, removeItem, removeItemsById  } from '../../redux/slice/cartSlice';
...
const CartItem = ({ id, title, type, size, price, count, imageUrl }) => {
    ...
    const onClickPlus = () => {
        dispatch(addItem({ id, title, type, size, price, imageUrl }));
    };
    ...
    const onClickRemove = () => {
        if (window.confirm('Vse huinia Misha? Po novoi?')) {
